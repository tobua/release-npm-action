...
var getRelease = () => {
  ...
  if ((0, import_core.getInput)("MANUAL_TRIGGER") === "regular") {
    release = true;
...
var createRelease = async () => {
  ...
  const folder = (0, import_core.getInput)("FOLDER");
  if (folder) {
    (0, import_core.info)(`Releasing from folder: ${folder}.`);
  }
  if (channelInput) {
  ...
  try {
    ...
    if (!releaseResult) {
      ...
      (0, import_core.info)(printedLogs);
      return;
    }
    ...
    (0, import_core.setOutput)("channel", channel);
    (0, import_core.setOutput)("tag", gitTag);
    (0, import_core.setOutput)("folder", folder);
  } catch (error) {
...
var run = async () => {
  try {
    ...
    (0, import_core2.info)(`release-npm-action with node: ${execSync2("node -v").toString()}`);
